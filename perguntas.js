...
criaCartao(
    '4. O que é o sistema de Plantio Direto?',
    'É uma técnica conservacionista onde a terra não é arada, e os restos da colheita anterior são deixados no solo. Ele retém umidade, evita a erosão e protege a terra.',
)

criaCartao(
    '5. Qual é o papel da rotação de culturas?',
    'Alternar diferentes plantas na mesma área ao longo do ano melhora a fertilidade do solo e previne pragas de forma natural, diminuindo a necessidade de defensivos químicos.',
)

criaCartao(
    '6. O que é Integração Lavoura-Pecuária-Floresta (ILPF)?',
    'É um sistema sustentável que integra atividades agrícolas, pecuárias e florestais na mesma área. Ele otimiza o uso da terra e melhora a qualidade do solo..',
)

criaCartao(
    '7. Como a gestão eficiente da água é aplicada no campo?',
    'Por meio de sistemas de irrigação inteligentes (como o gotejamento) e do reuso de água, que evitam o desperdício desse recurso vital.'
)
...
criaCartao(
    '9. A adoção de práticas sustentáveis aumenta os custos do produtor?',
    'A curto prazo pode exigir investimentos, mas a longo prazo reduz custos com insumos e protege o produtor contra eventos climáticos extremos.',
